...
public class EditCardButtons {
    ...
    private Mono<Void> editStats(ComponentInteractionEvent event, DudeCard card) {
        return event.presentModal(InteractionPresentModalSpec.builder()
                ...
                .addComponent(ActionRow.of(TextInput.small("cardattack", "⚔ Attack", 1, 5)
                        .required(true)
                        .prefilled(String.valueOf(card.getAttack()))
...
//                        .placeholder("New Defence")))
    ...
    private Mono<Void> editCost(ComponentInteractionEvent event, Card card) {
        return event.presentModal(InteractionPresentModalSpec.builder()
                ...
                .addComponent(ActionRow.of(TextInput.paragraph("cardcost", "Cost", 0, 5)
                        .required(false)
                        .prefilled(String.valueOf(card.getCost()))
